...
require_relative "lib/byebug_noop/version"

Gem::Specification.new do |spec|
  spec.name = "byebug_noop"
  spec.version = ByebugNoop::VERSION
  spec.authors = ["James Cowlishaw"]
  spec.email = ["james@cowlibob.co.uk"]
